...
export function ProductCard({ product, onClick, showPriceContribution = false }: ProductCardProps) {
  return (
    <Card 
      className="cursor-pointer hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-white to-blue-50/30 dark:from-gray-800 dark:to-blue-900/20 border-gray-200 dark:border-gray-700"
      onClick={onClick}
    >
